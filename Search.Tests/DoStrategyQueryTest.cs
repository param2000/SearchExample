...
{   
   ...
   {
       private readonly IList<String> searchlist;

       public DoStrategyQueryTest()
        {
            searchlist = new List<string> {"1", "1", "2", "3", "4"};
        }
       ...
       public void EqualityTest()
       {
           ...
           var search = new DoStrategyQuery<String>(list, searchlist.AsQueryable(),SearchFactory.GetInstanceOfSearchFactoru());
